Vue.component('contact_form_1722491195', {
  template: `
    <main class="flex justify-center align-center p-10">
      <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
        <div>
          <h3 class="text-black font-semibold text-xl">Get in Touch with FoodFindr</h3>
          <p class="mt-3 text-black w-fit">Let us know how we can help make finding great food easier for you.</p>
        </div>
        <form @submit.prevent class="space-y-5 mt-5">
          ...
          <div>
            <label class="font-medium text-black">Your email address</label>
          ...
          <div>
            <label class="font-medium text-black">How can we help you?</label>
          ...
          <div>
            <label class="font-medium text-black">Dietary restrictions or preferences</label>
          ...
          <button class="w-full px-4 py-2 text-white font-medium bg-green-600 hover:bg-green-500 active:bg-green-700 rounded-lg duration-150">Location</button>
        </form>
      </div>
    </main>
  `,
