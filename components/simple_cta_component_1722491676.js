...
Vue.component("simple_cta_component_1722491676", {
    template: `
    <section id="cta-component" style="min-height: 750px"   class="flex-1 bg-gradient-to-br from-pink-300 to-purple-600 p-8">
        <div id="cta-inner-container" class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6 bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg rounded-2xl shadow-lg">
            <div id="cta-content" class="max-w-screen-sm mx-auto text-center">
                ...
                <div id="great-button-container" class="flex mt-4">
                    ...
                    <a id="theming-button" href="#" class="flex-1 text-purple-800 bg-pink-200 bg-opacity-70 hover:bg-opacity-90 focus:ring-4 focus:ring-pink-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 transition duration-300 ease-in-out transform hover:scale-105">Themings1</a>
                </div>
        </div>
    </section>
        `,
